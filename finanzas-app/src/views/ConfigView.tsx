...
import { Settings, TrendingUp, TrendingDown, CreditCard, Plus, GripVertical, X, Trash2, LogOut, Save } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-full">
        <Card className="p-5 flex flex-col h-full">
          ...
          <div className="flex gap-2 mb-4">
            <input
              ...
              className="flex-1 px-3 py-2 border border-slate-200 rounded text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-white"
              value={newIncome}
        ...
        <Card className="p-5 flex flex-col h-full">
          ...
          <div className="flex gap-2 mb-4">
            <input
              placeholder="Nueva categoría..."
              className="flex-1 px-3 py-2 border border-slate-200 rounded text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 bg-white"
              value={newExpense}
        ...
        <Card className="p-5 flex flex-col h-full">
          ...
          <div className="flex flex-col gap-2 mb-4">
            <div className="flex flex-col gap-2">
              <input placeholder="Nombre..." className="px-3 py-2 border border-slate-200 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" value={newCard.name} onChange={e => setNewCard({ ...newCard, name: e.target.value })} />
              <input placeholder="Cupo..." type="text" className="px-3 py-2 border border-slate-200 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white" value={newCard.limit ? new Intl.NumberFormat('es-CL', { style: 'currency', currency: 'CLP' }).format(parseInt(newCard.limit)) : ''} onChange={handleCardLimitChange} />
            </div>
